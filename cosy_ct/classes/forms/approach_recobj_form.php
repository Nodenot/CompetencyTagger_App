 ...
 */
class cosy_ct_approach_recobj_form extends moodleform {
    public function definition() {
        ...
        $mform->addElement('select', 'approach_rec_obj', get_string('approachesrecobjlabel', 'block_cosy_ct'), $approachesarr);
    }
}