 ...
 */
class cosy_ct_desc_recobjedit_form extends moodleform {
    public function definition() {
        ...
        $mform->addElement('static', 'recobj_id', get_string('recobjid', 'block_cosy_ct'), $this->_customdata['recobj_id']);
        ...
        $mform->setDefault('description_rec_obj', $current_recobj->description);

        $mform->setType('comment_rec_obj', PARAM_RAW);
        $mform->addElement('text', 'comment_rec_obj', get_string('commrecobjlabel', 'block_cosy_ct'));
        $mform->setDefault('comment_rec_obj', $current_recobj->comment);
    }
}