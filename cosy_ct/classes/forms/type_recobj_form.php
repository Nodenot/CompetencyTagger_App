 ...
 */
class cosy_ct_type_recobj_form extends moodleform {
    public function definition() {
        ...
        $mform->addElement('select', 'type_rec_obj', get_string('typesrecobjlabel', 'block_cosy_ct'), $typesarr);
        $PAGE->requires->js_call_amd('block_cosy_ct/recobj_add_cosy_ct', 'init');
    }
}