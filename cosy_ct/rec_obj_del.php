...
require_once($CFG->dirroot . '/blocks/cosy_ct/classes/forms/dummy_recobj_form.php');
...
$urlpage = new moodle_url('/blocks/cosy_ct/rec_obj_del.php');
...
$dummy_form = new cosy_ct_dummy_recobj_form(
    $urlpage, array(
        'anchor_id' => $anchor->id,
        'recobj_id' => $recobjid,
    )
...
echo $OUTPUT->render_from_template('block_cosy_ct/rec_obj_del', $data);
